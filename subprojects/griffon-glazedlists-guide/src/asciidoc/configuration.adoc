...
----
dependencies {
    griffon '{groupId}:griffon-glazedlists-plugin:{project-version}'
}
----
...
----
dependencies {
    compile '{groupId}:griffon-glazedlists-swing:{project-version}'
}
----
...
----
dependencies {
    compile '{groupId}:griffon-glazedlists-swing-groovy:{project-version}'
}
----
