 ...
 */
class DefaultFXWritableTableFormatFactory extends AbstractFactory {
    Object newInstance(FactoryBuilderSupport builder, Object name, Object value, Map attributes)
        throws InstantiationException, IllegalAccessException {
        if (FactoryBuilderSupport.checkValueIsTypeNotString(value, name, DefaultFXWritableTableFormat)) {
            return value
        }
        ...
        if (attributes.containsKey('columns')) {
            ...
            if (columns instanceof List) {
                return new DefaultFXWritableTableFormat(columns)
