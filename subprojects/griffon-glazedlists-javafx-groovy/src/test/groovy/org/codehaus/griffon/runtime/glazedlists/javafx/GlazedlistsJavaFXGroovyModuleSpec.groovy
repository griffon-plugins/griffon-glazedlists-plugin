 ...
 */
class GlazedlistsJavaFXGroovyModuleSpec extends Specification {
    static {
    ...
    def 'Builder customizer is configured correctly'() {
        ...
        where:
        node                     | factory
        'fxTableFormat'          | DefaultFXTableFormatFactory
        'fxtWritableTableFormat' | DefaultFXWritableTableFormatFactory
        'eventTableViewModel'    | DefaultTableViewModelFactory
    }
