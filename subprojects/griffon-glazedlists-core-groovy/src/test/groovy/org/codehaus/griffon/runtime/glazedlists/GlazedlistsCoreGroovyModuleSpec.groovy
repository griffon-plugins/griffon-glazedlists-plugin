 ...
 */
package org.codehaus.griffon.runtime.glazedlists
 ...
 */
class GlazedlistsCoreGroovyModuleSpec extends Specification {
    static {
    ...
    def 'Builder customizer is configured correctly'() {
        ...
        where:
        node                         | factory
        'defaultTableFormat'         | DefaultTableFormatFactory
        'defaultWritableTableFormat' | DefaultWritableTableFormatFactory
        'defaultAdvancedTableFormat' | DefaultAdvancedTableFormatFactory
    }
